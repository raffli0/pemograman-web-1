CREATE DATABASE IF NOT EXISTS saas_asset_manager;
...
CREATE TABLE IF NOT EXISTS users (
    id INT AUTO_INCREMENT PRIMARY KEY,
    organization_id INT NULL, -- NULL for Super Admin (Platform Owner)
...
-- Super Admin Seed (Password: 123456)
INSERT INTO users (organization_id, name, email, password, role) VALUES 
(NULL, 'Platform Owner', 'super@saas.com', '$2y$10$p84DAX.ublfADSFvZsKbzOx0s2Rqvfqd.gh2F8OpsqL8ZYQSvR1Em', 'super_admin');
